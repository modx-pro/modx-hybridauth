...
$_lang['setting_ha.keys.X'] = 'Ключі для X';
$_lang['setting_ha.keys.X_desc'] = 'OAuth 2 додаток: <a target="_blank" href="https://developer.x.com/">developer.x.com</a>. JSON: {"keys":{"id":"...","secret":"..."},"scope":"tweet.read users.read users.email offline.access"}. Callback: {site_url}?hauth_done=X. Краще за legacy Twitter OAuth 1.0a.';
$_lang['setting_ha.keys.Twitter'] = 'Ключі для Twitter (legacy)';
$_lang['setting_ha.keys.Twitter_desc'] = 'Legacy OAuth 1.0a (старий Twitter API): <a target="_blank" href="https://developer.x.com/">developer.x.com</a>. У JSON потрібен consumer <code>key</code>: {"keys":{"key":"...","secret":"..."}}. Callback: {site_url}?hauth_done=Twitter. Нові додатки — ha.keys.X.';
...
$_lang['setting_ha.keys.VkId'] = 'Ключі для VK ID';
$_lang['setting_ha.keys.VkId_desc'] = 'OAuth 2.1 додаток у <a target="_blank" href="https://id.vk.com/about/business/go">кабінеті VK ID</a>. JSON: {"keys":{"id":"...","secret":"..."},"scope":"vkid.personal_info email"} (secret — захищений ключ; для public PKCE може бути порожнім). Callback: {site_url}?hauth_done=VkId. Сніпет: &providers=`VkId`. Документація: <a target="_blank" href="https://id.vk.com/about/business/go/docs/ru/vkid/latest/vk-id/connection/start-integration/auth-without-sdk/auth-without-sdk-web">авторизація без SDK</a>.';
$_lang['setting_ha.keys.Vkontakte'] = 'Ключі для Vkontakte (legacy)';
$_lang['setting_ha.keys.Vkontakte_desc'] = 'Legacy OAuth api.vk.com. Нові додатки — <code>ha.keys.VkId</code>. Приклад: {"keys":{"id":"...","secret":"..."},"scope":"email"}.';
